...
module.exports = {
    getAdminPage : async (req, res) => {
        try {
            ...
            res.render(__dirname + '/views/newAdmin.ejs', {coupleInfo : couples, newAnnouncements : announcements, newCouple : newCouple})
        } catch (err) {
...
<!--<img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="122" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://imgur.com/BGAKutK" height="10">-->
</td>
</tr>
</tbody>
...
<tr>
<td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
<!--<img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="600" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://imgur.com/Lh6mbJM" height="189">-->
</td>
</tr>
</tbody>
...
<div style="font-family: 'Times New Roman', serif">
<div class="" style="font-size: 14px; font-family: 'Cormorant Garamond', 'Times New Roman', Times, serif; mso-line-height-alt: 16.8px; color: #6b7066; line-height: 1.2;">
<p style="margin: 0; font-size: 22px; text-align: center; mso-line-height-alt: 26.4px;">We are so fortunate for all the future Chosson and Kallah's from our community. Please reach out (reply to this email) of you would like to participate in these bridal showers.</p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: 'Times New Roman', serif">
<div class="" style="font-size: 14px; font-family: 'Cormorant Garamond', 'Times New Roman', Times, serif; mso-line-height-alt: 16.8px; color: #6b7066; line-height: 1.2;">
<p style="margin: 0; font-size: 22px; text-align: center; mso-line-height-alt: 26.4px;">Participation is $65.00 per shower, although if that is too difficult, any amount is accepted.</p>
