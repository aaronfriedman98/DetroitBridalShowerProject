...
const collectionEmail = buildCollectionEmail(newCoupleString, couplesString)
...
// the dashboard preview). Table-based + inline styles for email clients;
// Cormorant Garamond with Georgia fallback; brand palette matches the site.
// ---------------------------------------------------------------------------
function buildCollectionEmail(newCoupleString, couplesString) {
  ...
  <table role="presentation" width="640" class="card" cellpadding="0" cellspacing="0" style="width: 640px; max-width: 640px;">
    <tr><td align="center" style="padding: 20px 30px 0;">
      <div style="font-family: ${sans}; font-size: 12px; color: #9b998e; line-height: 1.7;">
        ...
        Detroit Bridal Shower &middot; Southfield, Michigan
      </div>
    </td></tr>
  </table>
